# Use of Pop method to modify previous code
...
print(f"\nCan only invite 2 people over to dinner\n")

print(f"{guest_list.pop()}, we are unable to accomodate you at the dinner party on Tuesday. Apologies for the inconvenience!")
print(f"{guest_list.pop()}, we are unable to accomodate you at the dinner party on Tuesday. Apologies for the inconvenience!")
print(f"{guest_list.pop()}, we are unable to accomodate you at the dinner party on Tuesday. Apologies for the inconvenience!")
print(f"{guest_list.pop()}, we are unable to accomodate you at the dinner party on Tuesday. Apologies for the inconvenience!")
print(f"{guest_list[0]}, you have been invited to the dinner party on Tuesday at 7 p.m.")
